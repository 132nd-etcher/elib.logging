...
latex_documents = [
    (master_doc, 'ESST.tex', 'ESST Documentation',
     '132nd-etcher', 'manual'),
]
...
# “nitpicky mode”. Note that type should include the domain name if present. Example entries would be
...
# A dictionary mapping 'figure', 'table', 'code-block' and 'section' to strings that are used for format of figure
